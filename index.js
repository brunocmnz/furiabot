...
Estamos sempre em busca de novas conquistas e expandindo nossos horizontes! 💪✨`,
  ...
  trajetoriaPorAno: {
    2017: [
      "Em 2017, a FURIA foi fundada em Uberlândia-MG por André Akkari, Jaime Pádua e Cris Guedes. Sob a liderança de Nicholas Nogueira, conhecido como Guerri, a primeira equipe de Counter-Strike foi formada...",
    ],
    2018: [
      "Em 2018, a FURIA passou por um ano de construção e reconhecimento! 🏆 O time foi premiado como Organização do Ano...",
    ],
    2019: [
      "Em 2019, a FURIA deu um grande passo ao adquirir a equipe Uppercut, que competia em League of Legends...",
    ],
    2020: [
      "Em 2020, a FURIA deu um grande salto! 🚀 O ano foi marcado pela abertura do novo escritório em São Paulo...",
    ],
    2021: [
      "Em 2021, a FURIA se destacou em várias frentes! 🎉 Com equipes em diversos jogos...",
    ],
    2022: [
      "Em 2022, a FURIA teve um ano incrível! 🎉 Começamos com a estreia no documentário <b>Do Brasil Para o Mundo</b>...",
    ],
    2023: [
      "Em 2023, a FURIA continuou sua trajetória de sucesso e expansão! 🚀 Inauguramos um novo centro de treinamentos em Malta...",
    ],
    2024: [
      "Em 2024, a FURIA deu mais um passo gigante na sua trajetória! 🚀 Mudamos para um novo escritório em São Paulo...",
    ],
    2025: [
      "Em 2025, a FURIA está se expandindo ainda mais! A organização anunciou a entrada de Neymar Jr. como co-presidente...",
    ],
  },
...
async function conversarComTorcedorFuria(chatId, mensagem) {
  const historico = modoTorcidaAtivo.get(chatId);
  if (!historico) return "⚠️ O modo torcida está inativo.";
  ...
  try {
    ...
    if (json.candidates && json.candidates.length > 0) {
      ...
      historico.push({ role: "model", parts: [{ text: texto }] }); // adiciona ao histórico do chat
      return texto;
    } else {
      console.error(
